/* Include necessary libraries for the Assembler */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <ctype.h>

/* Define constants to be used in the Assembler program */
#define MINUS_TWO -2
#define MINUS_ONE -1
#define FALSE 0
#define ZERO 0
...
/* Struct for holding a command and its numeric values */
...
/* Struct for saving a macro and its contents */
typedef struct macro {
    char name[MAX_LINE_SIZE];
    char content[MAX_LINE_SIZE * MAX_LINE_SIZE];
} macro;

/* Struct for holding a label and its details */
